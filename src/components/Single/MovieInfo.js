      ...
      <div className="xl:bg-main bg-dry flex-colo xl:bg-opacity-90 xl:absolute top-0 bottom-0 right-0 left-0 ">
        <div className="container px-3 mx-auto 2xl:px-32 xl:grid grid-cols-3 flex-colo py-10 lg:py-20 gap-8 ">
          <div className="w-70 xl:col-span-1  xl:order-none order-last h-header bg-dry border  border-gray-800 rounded-lg overflow-hidden">
            <img
              src={`/images/imageTitle/${movie?.titleImage}`}
              alt={movie.name}
          ...
          <div className="col-span-2 md:grid grid-cols-5 gap-4 items-center">
            <div className="col-span-3 flex flex-col gap-10">
              ...
              <div className="flex items-center gap-4 font-medium text-dryGray">
                <div className="flex-colo rounded-sm bg-submain text-xs px-2 py-1">
                  HD 4K
                </div>
              ...
              <div className="grid sm:grid-cols-5 gris-cols-3 gap-4 p-6 bg-main border border-gray-800 rounded-lg">
                {/* share */}
                ...
                {/* language */}
                <div className="colo-span-2 flex-colo font-medium text-sm">
                  <p>
                    Language :{" "}
